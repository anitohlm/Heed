                ...
                "properties": {
                    ...
                    "payload": {
                        ...
                        "description": (
                            ...
                            "importance?, explicit_cadence_days?, next_due_at?, status? } — only "
                            "include the fields you intend to change. category must be one of the "
                            "seven valid values. status must be one of: active, paused, archived. "
                            "next_due_at must be an ISO date string (YYYY-MM-DD or full datetime) — "
                            "convert relative phrasings yourself ('by Saturday' → '2026-05-09'). "
